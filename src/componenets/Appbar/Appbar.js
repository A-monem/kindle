            ...
            {matches ? (
              ...
              <>
                ...
                <Menu
                  ...
                  onClose={handleClose}
                >
                  <MenuItem onClick={() => history.replace(strings.dashboard_url)}>Dashboard</MenuItem>
                  <MenuItem onClick={() => history.replace(strings.search_url)}>Search</MenuItem>
                  <MenuItem onClick={() => history.replace(strings.timesheets_url)}>Timesheet</MenuItem>
                  <MenuItem onClick={() => history.replace(strings.jobs_url)}>Job Board</MenuItem>
                  <MenuItem onClick={() => history.replace(strings.messages_url)}>Messages</MenuItem>
                  <MenuItem onClick={handleProfile}>Profile</MenuItem>
                  <MenuItem onClick={handleSignOut}>Sign out</MenuItem>
                </Menu>
              </>
